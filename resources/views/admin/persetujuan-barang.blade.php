                        ...
                        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                            ...
                            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                                ...
                                <div class="flex justify-center">
                                    <img src="https://picsum.photos/id/237/200/300" class="rounded-lg" alt="">
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-800 dark:text-white/90">Laptop Asus ROG</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-800 dark:text-white/90">Elektronik</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-800 dark:text-white/90">
                                        Laptop untuk kebutuhan desain grafis dan editing video.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-800 dark:text-white/90">5 Unit</p>
                                </div>
